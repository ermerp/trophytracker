...
| Lücken | 3 | `/luecken`, in der Leiste (seit Stufe 14): digital gespielt, Disc-Fassung belegt, nicht im Regal – Cover, Plattform, Fortschritt, Platin, eigener Status, Gebrauchtpreis („unbekannt" bis Stufe 18). Knopf „physisch nicht gewünscht" mit Rückgängig; verworfene standardmäßig ausgeblendet, per Umschalter sichtbar mit „wieder als Lücke zeigen". Darunter zugeklappt „Disc-Fassung unbekannt (n)" mit „Disc gibt es" / „gibt es nicht" / „physisch nicht gewünscht" je Zeile (5.3, Block B). Im Spieldetail je Release ein Dropdown ja/nein/unbekannt mit Quelle (aus IGDB, von Hand) und das Feld PSN-Produkt-Id; in den Einstellungen unter IGDB der Knopf „Disc-Fassungen prüfen" mit Zählern (7.6) |
