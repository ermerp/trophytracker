...
**Symbol und Gestaltung:** Das App-Symbol ist ein eigener schlichter Pokal (`frontend/public/icon.svg`, PNGs aus `@vite-pwa/assets-generator`, `pwa-assets.config.ts`). **Regel für jede Gestaltungsentscheidung (Nutzer, 19.09.2026): keine PlayStation-Logos, -Symbole oder -Schriftzüge, auch nicht angedeutet oder abstrahiert** – geschützte Marken, das Repository ist öffentlich. Plattformnamen als Text („PS4", „Vita") sind Daten, kein Logo.
