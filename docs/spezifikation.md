...
- **Verworfen: römische Zahlen vereinheitlichen** (II → 2). Klingt naheliegend, erzeugte aber drei neue Fehlgriffe (Darksiders → Darksiders III, God of War → God of War III) und bleibt draußen.

*Ergebnis der Messung:* eBay kennt 33 der 34 bereits zugeordneten Codes und 18 der 22 offenen. Mit beiden Korrekturen werden **30 von 30** bekannten Codes richtig zugeordnet – kein Fehlgriff – und **15 der 22** bisher unlösbaren Codes eindeutig; zwei weitere liefern einen brauchbaren Titel zu einem Spiel, das die Sammlung noch nicht kennt (dort ist der Titel die Vorlage zum Anlegen). Die Messung lief im Scratchpad gegen die echten Codes; ins Repository kamen nur Zahlen.
