...
- **Suche und Filter:** Die Suche klappt erst auf Tippen auf die Lupe auf („nimmt immer oben sehr viel Platz weg", Rückmeldung vom 22.09.2026); ein gesetzter Begriff hält sie offen. Filter sind **Chips** in einer waagerecht scrollbaren Reihe, gesetzte zuerst und in Gold mit Kreuz, am Ende ein Chip „Filter zurücksetzen". Dieselbe Gestalt in Sammlung und Listen – vorher waren es dort Dropdowns und hier Kästchen.
