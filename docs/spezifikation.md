...
| 17 | Barcode-Scan mit Auflösungskette (ohne Feed): `/scannen` mit Handy-Kamera und Laptop-Webcam, Polyfill `barcode-detector`, Suche in der Sammlung, „Spiel anlegen", offene Scans; keine Migration | Komfort bei Erfassung – erster neuer Schreiber im Protokoll („per Barcode"); Trefferquote externer Quellen nach dem Regal-Erfassen gegen echte Codes zu messen (9.2) |
