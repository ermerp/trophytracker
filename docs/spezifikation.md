...
**PWA (Stufe 18, `vite-plugin-pwa`, Workbox `generateSW`):** Manifest (`Trophytracker`, `standalone`, `lang de`, Symbole 64/192/512, maskable, Apple-Touch) und Service Worker mit `autoUpdate`. Strategien:
