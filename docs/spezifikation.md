...
- **Stufe 4 läuft wie „Spiel anlegen" in der Sammlung** (dieselbe Komponente, `frontend/src/SpielAnlegen.tsx`): Titel (mit dem Suchtext vorbelegt) und Plattform; bei gleichem Titelschlüssel die Kandidaten mit „Release anhängen", „vorhandenes Release verwenden" oder „Trotzdem als neues Spiel anlegen". Kein IGDB-Suchfeld im Scanner – der nächste Abgleich (7.6) holt den Eintrag nach.
